    ...
    this.draw = function (percent) {
        ...
        if (!!options.scaleColor || !!options.trackColor) {
            ...
            if (ctx.getImageData && ctx.putImageData) {
                if (!cachedBackground) {
                    drawBackground();
                    cachedBackground = ctx.getImageData(0, 0, options.size * scaleBy, options.size *
                        scaleBy);
                } else {
...
var FilamentSparkPie = function (el, opts) {
    ...
    var init = function () {
        ...
        if (typeof (options.easing) === 'string' && typeof (jQuery) !== 'undefined' && jQuery.isFunction(
...
window.FilamentSparkPie = FilamentSparkPie
